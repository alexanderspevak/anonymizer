...
// DO NOT EDIT.
// source: schemas/http_log.capnp


pub mod http_log_record {
  #[derive(Copy, Clone)]
  pub struct Owned(());
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_timestamp_epoch_milli(self) -> u64 {
    ...
    #[inline]
    pub fn get_request_time_milli(self) -> u64 {
      self.reader.get_data_field::<u64>(3)
    }
    #[inline]
    pub fn get_response_status(self) -> u16 {
      self.reader.get_data_field::<u16>(16)
    }
    #[inline]
    pub fn get_cache_status(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_timestamp_epoch_milli(&mut self, value: u64)  {
    ...
    #[inline]
    pub fn set_request_time_milli(&mut self, value: u64)  {
    ...
    #[inline]
    pub fn set_response_status(&mut self, value: u16)  {
      self.builder.set_data_field::<u16>(16, value);
    }
    #[inline]
    pub fn get_cache_status(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_cache_status(&mut self, value: ::capnp::text::Reader<'_>)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_cache_status(self, size: u32) -> ::capnp::text::Builder<'a> {
    ...
    #[inline]
    pub fn set_method(&mut self, value: ::capnp::text::Reader<'_>)  {
    ...
    #[inline]
    pub fn set_remote_addr(&mut self, value: ::capnp::text::Reader<'_>)  {
  ...
  mod _private {
    ...
    pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 5, pointers: 4 };
    pub const TYPE_ID: u64 = 0xc5c6_6f22_213a_da4b;
  }
}
